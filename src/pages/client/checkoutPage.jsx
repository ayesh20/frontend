  ...
  return (
    <div className="w-[100vw] max-w-[100vw] h-screen flex flex-col px-[10px] py-[40px] items-center">
      {cart.map((item, index) => {
        return (
          ...
          >
            ...
            <div className="w-[190px] h-full text-3xl md:text-lg flex flex-row justify-center items-center">
              <button
                className="flex justify-center items-center w-[30px] bg-blue-600 rounded-lg bg-accent text-white cursor-pointer hover:bg-blue-400"
                onClick={() => {
                  const newCart = [...cart];
            ...
            <div className="w-[190px] text-3xl md:text-2xl h-full flex justify-end items-center pr-[10px]">
      ...
      <div className="md:w-[800px] w-full h-[100px] m-[10px] p-[10px] shadow-2xl flex flex-row items-center justify-end relative">
        ...
        <button
          onClick={placeOrder}
          className="absolute left-[10px] w-[200px] text-1xl md:text-md md:w-[150px] h-[50px] cursor-pointer rounded-lg shadow-2xl bg-accent border-[2px] bg-blue-600 border-accent text-white hover:bg-blue-400 hover:text-accent"
        >
          Place Order
        </button>
      </div>
