	...
	return (
		<div className="w-[100vw] max-w-[100vw] h-screen flex flex-col px-[10px] py-[40px] items-center">
				...
				return (
					...
					>
						...
						<div className="w-[190px] h-full text-3xl md:text-lg  flex flex-row justify-center items-center ">
							<button
								className="flex justify-center items-center w-[30px] rounded-lg bg-accent bg-blue-600 text-white cursor-pointer hover:bg-blue-400"
								onClick={() => {
									addToCart(item, -1);
									setCart(getCart());
								}}
						...
						<div className="w-[190px] text-3xl md:text-lg h-full flex justify-end items-center pr-[10px]">
			...
			<div className="md:w-[800px] w-full h-[100px] m-[10px] p-[10px] shadow-2xl flex flex-row items-center justify-end relative">
				...
				<button
					className="absolute left-[10px] w-[200px] text-2xl md:text-lg md:w-[150px] h-[50px] cursor-pointer rounded-lg shadow-2xl bg-accent bg-blue-600 border-[2px] border-accent text-white hover:bg-blue-400 hover:text-accent"
					onClick={() => {
